...
******************************************************************}
  ...
  <form action="{$settings.dburl}/index.php?act=report&amp;id={$id}&amp;email&amp;process" method="post">
  ...
  <tr>
    ...
    <td width="50%"><textarea name="message" style="width: 95%; height: 200px;"></textarea></td>
  </tr>
  <tr>
